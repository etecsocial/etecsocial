@extends('app')
@section('title')
ETEC Social | Compartilhe um conhecimento
@stop
...
<nav class="red darken-1" role="navigation">
    ...
    <div class="section no-pad-bot">
      <div class="container">
        <br><br>
        <h1 class="header center red-text text-darken-2">Entre na rede de seus amigos!</h1>
        <div class="row center">
          <h5 class="header col s12 light">Compartilhe conhecimentos juntos e desafie seus amigos!</h5>
        </div>
        <div class="row center">
  ...
  <div id="index-frase">
    <div class="section no-pad-bot">
      <div class="container">
        <div class="row center">
          <h5 class="header col s12 light">"Se a educação sozinha não transforma a sociedade, sem ela tampouco a sociedade muda." - Paulo Freire</h5>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col l3 s12">
          ...
          <ul>
            <li><a class="white-text" href="#!">Sobre o projeto</a></li>
        ...
        <div class="col l3 s12">
          ...
          <ul>
            <li><a class="white-text" href="#!">facebook.com/etecsoc</a></li>
            <li><a class="white-text" href="#!">twitter.com/etecsocial</a></li>
            <li><a class="white-text" href="#!">contato@etecsocial.com</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div id="entrar" class="modal ">
    <div class="modal-content">
      <h4>Entrar</h4>
         ...
         <div class="form-group">
                    ...
                    'class' => 'form-control',
                    'placeholder' => 'Usuário, email ou rm',
                    'autocomplete' => 'off'
                    ]) !!}
                </div>
                <div class="form-group">
                ...
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="remember"><p class="conn">Manter conectado(a) |  <a data-toggle="modal" href="#!">Perdeu sua senha?</a></p> 
                    </label>
                </div>
    ...
    <div class="modal-footer">
    	 ...
    	 <input type="submit" class="waves-effect waves-green btn-flat red white-text" value="Entrar">
    </div>
  </div>
  {!! Form::close() !!}
  ...
  <div id="cadastrar" class="modal modal-fixed-footer">
    <div class="modal-content">
      ...
      <div class="form-group">
      	...
      	<input type="text" name="nome" class="form-control" placeholder="Alberto Ramos" required>
       </div>
       <div class="form-group">
        ...
        <div class="form-group">
	        <label for="instituicao">Selecione sua ETEC:</label>
	        <select name="instituicao" class="form-control">
	        	<option value="das">Selecione a ETEC</option>
	        	<option value="das">ETEC Pedro Ferreira Alves</option>
	        </select>
		</div>
