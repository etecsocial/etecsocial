    ...
    <div id="card-widgets" class="seaction">
        <div class="row">
            ...
            <div class="col s12" id="post">
                    ...
                    <div class="card">
                     ...
                     <img src="{{ url($post->url_midia) }}">
                        ...
                        <div class="row" id="autor-post">
                            ...
                            <a href="#modalExcluir" onclick="excluir({{ $post->id }})" class="wino"><i class="material-icons dropdown-button waves-effect waves-light tooltipped" style="opacity: 0.7" data-tooltip="Excluir Publicação" data-delay="50" data-position="bottom">close</i></a> @else
                            <a href="#modalDenuncia" class="wino"><i class="material-icons dropdown-button waves-effect waves-light tooltipped" style="opacity: 0.7" data-tooltip="Denunciar usuário" data-delay="50" data-position="bottom">turned_in</i></a> @endif
                        </div>
                        <div class="card-reveal">
                            ...
                            <ul class="collection" id="comentarios-{{ $post->id }}" style="margin-top:15px">
                                ...
                                <li id="com-{{ $comentario->id }}" class="collection-item avatar com-{{ $post->id }}" style="height: auto; min-height:65px;max-height: 100%" data-id="{{ $comentario->id }}">
                                    ...
                                    <a href="#modalExcluirComentario" onclick="excluirComentario({{ $post->id }}, {{ $comentario->id }})" class="wino"><i class="mdi-navigation-close right tiny"></i></a> @endif
                ...
                @endforeach @foreach($posts_publicos as $post)
                <div data-id="{{ $post->id }}" class="blog post col s12 m6 l4" style="margin-top: 20px">
                    <div class="card">
                        <div class="card-image waves-effect waves-block waves-light">
                            @if($post->is_imagem)
                ...
                @endforeach @if(!isset($posts_amigos[0]))
