<div id="material" class="tab-content col s12">
    ...
    <div class="col s6">
        <ul class="collection">
            <li class="collection-item avatar" style="height: auto">
                ...
                </p><a href="#!" class="secondary-content"><i class="material-icons">http</i></a> @elseif($material->tipo == 'midia') Foto - Video
                <a href="{{ url($material->caminho)}}" data-lightbox="joao">Visualizar</a>
                </p><a href="#!" class="secondary-content"><i class="material-icons">perm_media</i></a> @else Documento
                <a href="{{ url($material->caminho)}}">Fazer download</a>
                </p><a href="#!" class="secondary-content"><i class="material-icons">description</i></a> @endif
            </li>
        </ul>
    </div>
    @endforeach @else
    ...
    @endif @elseif(isset($materiais[0])) @foreach($materiais as $material)
    <div class="col s6">
        <ul class="collection">
            <li class="collection-item avatar" style="height: auto">
                <img src="{{ auth()->user()->avatar($material->autor_id) }}" data-tooltip="Este é {{ auth()->user()->verUser($material->autor_id)->nome }}" class="circle tooltipped">
                ...
                <a href="{{ url($material->caminho)}}">Fazer download</a>
                </p><a target="_blank" href="#!" class="secondary-content"><i class="material-icons">description</i></a> @endif
            </li>
        </ul>
    </div>
    @endforeach @else
