...
<div class="wrapper">
   <aside id="left-sidebar-nav">
      <ul id="slide-out" class="side-nav fixed leftside-navigation collapsible" data-collapsible="accordion" >
         ...
         <li class="bold">
            <a class="waves-effect waves-cyan collapsible-header"><i class="mdi-action-assessment color-sec-darken-text"></i> Ranking</a>
            ...
            <div class="col s12 m12 14 transparent white-text">
               ...
               <div id="notificacoes" class="col s12" style="display: block;">
                  <p><span class="left-align">Notificações</span>
                     <span class="right-align right"><small><a style="cursor:pointer" onclick="read()">Marcar como lido</a></small></span>
                  </p>
