...
class PerfilController extends Controller {
    ...
    public function update(Request $request) {
        Carbon::setLocale('pt_BR');
        return $request;
        if ($u = User::where("id_user", $request->id_user)->first()) {
    ...
    public function status(Request $request) {
        ...
        $pro1 = array("Não", "Nao", "Não!", "Nao!", "não", "nao", "não!", "nao!");
        $pro2 = array("Sim", "Sim!", "sim", "sim!");
        ...
        if (in_array($request->status, $pro2)) {
